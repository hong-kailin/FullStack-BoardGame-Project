...
| 二 | Web 界面（本地双人） | 22 课 | 浏览器中可玩的本地双人游戏 |
...
- 完整跑通一局游戏
- 测试所有胜利条件
- **产出**：可在浏览器中完整游玩的双人对战游戏

### 第 33 课：引入 React
- 原生 JS 的痛点：手动操作 DOM 太麻烦
- React 的核心思想：组件化、声明式
- **产出**：用 React 重写一个小组件

### 第 34 课：React 组件化改造
- 把页面拆成组件（Board、Pyramid、PlayerPanel）
- props 传递数据、useState 管理状态
- **产出**：完整的 React 版游戏界面
...
### 第 35 课：为什么需要 monorepo？
### 第 36 课：动手搭建 Monorepo 骨架
### 第 37 课：拆分代码到子包
...
### 第 38 课：Node.js 原生 HTTP 服务器
### 第 39 课：引入 Express
### 第 40 课：文件存储用户数据
### 第 41 课：引入 SQLite 数据库
### 第 42 课：Session 与 Cookie
### 第 43 课：前端接入用户系统
