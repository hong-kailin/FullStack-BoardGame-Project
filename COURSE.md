...
| 三 | React 重构 | 10 课 | 用 React + TypeScript 重构游戏界面 |
...
### 第 38 课：React 版 UI 美化
- 综合运用 CSS 美化 React 版游戏
- **产出**：React 版游戏界面美观可用

### 第 39 课：引入游戏逻辑
- 从 `web/game.js` 导入游戏函数
- 在 React 组件中调用 takeTokens、purchaseCard
- **产出**：React 版游戏逻辑完整可用

### 第 40 课：React 版联调
- 完整跑通一局游戏
- 对比原生版和 React 版的差异
- **产出**：可在浏览器中完整游玩的 React 版游戏

---

# 阶段四：Monorepo 拆分（3 课时）

### 第 41 课：为什么需要 monorepo？
### 第 42 课：动手搭建 Monorepo 骨架
### 第 43 课：拆分代码到子包
...
### 第 44 课：Node.js 原生 HTTP 服务器
### 第 45 课：引入 Express
### 第 46 课：文件存储用户数据
### 第 47 课：引入 SQLite 数据库
### 第 48 课：Session 与 Cookie
### 第 49 课：前端接入用户系统
